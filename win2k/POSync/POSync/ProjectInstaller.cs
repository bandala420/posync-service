...
namespace POSync
{
    ...
    public partial class ProjectInstaller : Installer
    {
        ...
        private void serviceInstaller1_AfterInstall(object sender, InstallEventArgs e)
        {
            ...
            if (AppInstaller.FindDirectory() == null)
                throw new InstallException("ALERTA: No se ha encontrado el directorio de archivos, revise la instalación de NewPos y vuelva a intentarlo. \nSi el problema persiste solicite asistencia técnica.");

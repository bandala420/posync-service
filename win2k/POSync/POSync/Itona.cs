...
namespace POSync
{
    static class Itona
    {
        ...
        public static void UpdateNewpos(bool restartPc)
        {
            ...
            FileTransfer.DownloadFiles(filesToDownload.ToArray(), localPath);
        ...
        {
            string rootFolder = ConfigurationManager.AppSettings["DriveLetter"] + "Data";
        ...
        private static void UploadInformationFiles()
        {
            ...
            FileTransfer.UploadFiles(fileToUpload, foldersToUpload, false);
        }
    }
}
